...
<body>
    ...
    <p class="texte_back"></p>

    <?php

    //login to the database
    try {
        $bdd = new PDO('mysql:host=globamyglobal.mysql.db;dbname=globamyglobal;charset=utf8', 'globamyglobal', 'SPBPNNWts3PuGeF1');
    } catch (Exception $e) {
    ...
    ?>
    <a href="csv.php"> Exporter les informations au format CSV </a>


    <div id="content">

        <a href='back_office.php?deconnexion=true'><span>Déconnexion</span></a>
